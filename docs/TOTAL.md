# Namo Documentation Index (TOTAL.md)

This document serves as the primary index for the Namo project documentation. All documentation is organized into functional subdirectories with files named in **UPPERCASE** for clarity and consistency.
...
- **[Buffer & Window Management](core/BUFFER_WINDOW_MANAGEMENT.md)**: Details how Namo handles buffers, windows, and their interactions.
