...
Namo follows the classic Model-View architecture where **Buffers** represent the data (Model) and **Windows** represent the viewports (View).
...
## 4. Screen Splitting
Namo supports vertical screen splitting.
