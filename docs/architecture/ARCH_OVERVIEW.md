# Namo Architectural Overview

Namo is a modern, nano-inspired user interface layer built on top of the classic uEmacs/PK text editor. It maintains the powerful internal buffer and window management of uEmacs while providing a more intuitive, visual experience similar to modern terminal editors.
...
- **UI/Namo Layer (`namo.c`, `display.c`, `highlight.c`)**: Handles the visual experience, status bars, syntax highlighting, and the configuration system.
